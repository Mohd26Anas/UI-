...
const Calculator = () => {
	...
	return (
		<div className="flex xs:flex-col lg:flex-row  h-full bg-white py-21 px-15.75 rounded-15 justify-between gap-15.75">
			<div className="flex flex-col w-full lg:w-1/2 gap-5 justify-between py-2 pl-2 lg:pr-10">
				...
				<div className="gap-5 grid grid-cols-3 ">
					{[5, 10, 15, 25, 50].map((percentage) => (
						<span
							...
							onClick={() => {
								setIsFocused(false);
								setState((prev) => ({ ...prev, tip: percentage,customTip:0 }));
							}}
